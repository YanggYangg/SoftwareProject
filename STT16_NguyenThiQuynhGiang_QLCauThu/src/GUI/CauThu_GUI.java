...
public class CauThu_GUI extends JFrame  implements ActionListener, MouseListener {
	...
	private ViTriThiDau_DAO vtri_dao;

	public CauThu_GUI() {
		
		//Khởi tạo kết nối tới SQL
		try {
	...
	public void DocDuLieuDatabaseVaoTable() {
		ArrayList<CauThu> list = ct_dao.getalltbCauThu();
		for(CauThu ct : list) {
			dataModel.addRow(new Object[] {ct.getMaSoCauThu(), ct.getTenCauThu(),
					ct.getTuoi(), ct.getVtri().getMaViTri()
			});
		}
	}
	@Override
